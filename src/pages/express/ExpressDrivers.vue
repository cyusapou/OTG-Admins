<template>
  ...
  >
    <DataTable
      ...
      :loading="loading"
      :error="error"
      emptyIcon="fas fa-id-card"
      emptyTitle="No drivers"
      emptySubtitle="Drivers are assigned through depot managers"
      @retry="loadData"
    >
...
async function loadData() {
  ...
  error.value = ''
  try {
    const [drivers, depots, buses, notifs, company] = await Promise.all([
